from ChefsHatGym.agents.util.memory_buffer import MemoryBuffer
...
class AgentDQL(ChefsHatPlayer):
    ...
    loadFrom = {
        ...
        "vsEveryone": "Trained/dql_vsEveryone.h5",
    ...
    def loadModel(self, model):
        self.actor = tf.keras.models.load_model(model, custom_objects={'mse': 'mean_squared_error'})
        self.targetNetwork = tf.keras.models.load_model(model, custom_objects={'mse': 'mean_squared_error'})
